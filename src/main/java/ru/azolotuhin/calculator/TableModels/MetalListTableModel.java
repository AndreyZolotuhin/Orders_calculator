...
import ru.azolotuhin.calculator.Metal.*;
...
public class MetalListTableModel extends AbstractTableModel {

    private List<MetalElement> metalList = new ArrayList<>();

    public MetalListTableModel(List<MetalElement> metalList) {
        super();
